...
const Skills = () => {
    ...
    return (
        <div
            className="z-10 relative flex p-6 mt-10 md:flex-row flex-col"
            id="skills"
        >
            ...
            <div className="w-full md:w-[40vw] order-1 md:order-2 p-4 rounded-lg z-10 relative flex flex-col justify-center items-center">
                {hoveredSkill ? (
                    ...
                    <div className="border-t-2 border-b-2 w-full p-4 flex justify-between">
                        <div className="w-2/3">
                            <h1 className="font-serif font-extrabold text-4xl md:text-6xl">
                                My
                            </h1>
                            ...
                            <h1 className="text-sm md:text-md">
                                Hover on a skill for more information.
                            </h1>
                        </div>
                        <Image
                            src="/coding.svg"
